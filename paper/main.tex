...
\DeclareFontShape{TU}{lmr}{m}{sl}{<->sub * lmr/m/it}{}
\DeclareFontShape{TU}{lmr}{m}{sc}{<->sub * lmr/m/n}{}
\DeclareFontShape{TU}{lmr}{b}{n}
  {<-> \UnicodeFontFile{lmroman10-bold}{\UnicodeFontTeXLigatures}}{}
\DeclareFontShape{TU}{lmr}{bx}{n}
  {<-> \UnicodeFontFile{lmroman10-bold}{\UnicodeFontTeXLigatures}}{}
\DeclareFontShape{TU}{lmr}{b}{it}{<->sub * lmr/b/n}{}
\DeclareFontShape{TU}{lmr}{bx}{it}{<->sub * lmr/bx/n}{}
\DeclareFontFamily{TU}{lmtt}{}
\DeclareFontShape{TU}{lmtt}{m}{n}
  {<-> \UnicodeFontFile{lmmono10-regular}{\UnicodeFontTeXLigatures}}{}
...
\fi
\begin{center}
{\Large A Fixed-Backbone Exclusion for Length-70 Binary
  $(9,1)$ Covering Sequences\par}
\vspace{1.5em}
Ruturaj R Raval\\
...
\begin{tabular}{@{}p{0.13\textwidth}p{0.38\textwidth}
  p{0.38\textwidth}@{}}
\toprule
