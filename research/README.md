...
The primary target is a valid 70-bit sequence. The finite proof lane studies
the exact 61-edge overlap shell of the retained 64-edge common backbone, while
the construction lane performs support surgery and exact repair around the
six-gap seed.
